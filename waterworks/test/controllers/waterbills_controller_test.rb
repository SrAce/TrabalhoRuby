...
class WaterbillsControllerTest < ActionController::TestCase
  ...
  test "should create waterbill" do
    assert_difference('Waterbill.count') do
      post :create, waterbill: { consume: @waterbill.consume, consuption: @waterbill.consuption, month: @waterbill.month, year: @waterbill.year }
    end
  ...
  test "should update waterbill" do
    patch :update, id: @waterbill, waterbill: { consume: @waterbill.consume, consuption: @waterbill.consuption, month: @waterbill.month, year: @waterbill.year }
    assert_redirected_to waterbill_path(assigns(:waterbill))
  end
